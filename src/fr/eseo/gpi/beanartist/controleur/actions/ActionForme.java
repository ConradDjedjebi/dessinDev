...
public class ActionForme extends AbstractAction  {
    ...
    public ActionForme (FenêtreBeAnArtist fenetre, int typeAction) {
        ...
        {
            case RECTANGLE:
                nomAction = NOM_ACTION_RECTANGLE;
                break;
                
            case CARRÉ:
                nomAction = NOM_ACTION_CARRÉ;
                break;
                
            case ELLIPSE:
                nomAction = NOM_ACTION_ELLIPSE;
                break;
                
            case CERCLE:
                nomAction = NOM_ACTION_CERCLE;
                break;
                
            case LIGNE:
                nomAction = NOM_ACTION_LIGNE;
                break;

            case TRACÉ:
                nomAction = NOM_ACTION_TRACÉ;
                break;

            default:
                throw new InvalidParameterException();
        }
        putValue(javax.swing.Action.NAME, nomAction);
